...
<rect x="X" y="Y" width="W" height="H" rx="2" fill="#F7F9F9"/>
<!-- Cell body -->
<rect x="X" y="Y" width="W" height="H" rx="2" data-share="18.29" fill="rgba(43,49,57,0.16)" stroke="rgba(43,49,57,0.30)" stroke-width="1"/>
<text x="X+16" y="Y+28" fill="#2B3139" font-size="13" font-weight="600" font-family="'Geist', sans-serif">NAME</text>
<text x="X+16" y="Y+46" fill="#535A63" font-size="9" font-family="'Geist Mono', monospace">VALUE · SHARE</text>
```

Focal cell: replace the fill with `rgba(26,118,180,0.16)` and the stroke with `#1A76B4` at 1.5px.
