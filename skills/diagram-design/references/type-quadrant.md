...
- **Axis lines**: `ink` (`#2B3139`), `stroke-width: 1.2`, `marker-start` + `marker-end` both pointing outward.
- **Focal quadrant tint**: `rgba(26,118,180,0.04)` full rect behind the focal cell.
