...
- Circle fill: very low-opacity tint — `rgba(43,49,57,0.04)` for ink set, `rgba(83,90,99,0.05)` for muted. Tints compound naturally in overlap regions.
...
- **Accent accent** on the ONE focal intersection — the "sweet spot". Either accent label stroke OR clipPath-bounded accent fill tint (`rgba(26,118,180,0.10)`).
