...
<text x="904" y="36" fill="#2B3139" font-size="14" font-style="italic"
...
<path d="M 820 44 Q 700 84 520 216" fill="none"
      stroke="rgba(43,49,57,0.40)" stroke-width="1" stroke-dasharray="4,3"/>
<!-- 3. Landing dot -->
<circle cx="520" cy="216" r="2" fill="#2B3139"/>
```
...
| Intent | Text | Leader |
|---|---|---|
| Neutral aside | ink `#2B3139` | `rgba(43,49,57,0.40)` |
| Focal / accent | accent `#1A76B4` | `rgba(26,118,180,0.50)` |
| Tertiary (muted) | muted `#535A63` | `rgba(43,49,57,0.30)` |
