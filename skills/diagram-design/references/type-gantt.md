...
- **Phase grouping:** a subtle zone rect (same pattern as architecture zone) behind each phase's rows, with an eyebrow label in the top-left margin. Use `rgba(43,49,57,0.02)` fill, `rgba(43,49,57,0.10)` stroke.
...
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(83,90,99,0.15)" stroke="#535A63" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#2B3139" font-size="10" font-weight="600"
      font-family="'Geist', sans-serif">Task name</text>

<!-- Focal task -->
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(26,118,180,0.12)" stroke="#1A76B4" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#1A76B4" font-size="10" font-weight="600"
