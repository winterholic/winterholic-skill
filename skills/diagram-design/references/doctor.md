...
3. Expected installed script presence
- In every mode, verify these installed runtime scripts exist:
  - `scripts/self_check.py`
  - `scripts/geometry_check.py`
  - `scripts/verify-geometry.py`
  - `scripts/artifact_gate.py`
- Missing installed runtime scripts are `fail`.

4. Expected maintainer script presence (maintainer-checkout mode only)
